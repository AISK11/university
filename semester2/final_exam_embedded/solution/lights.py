...
def initHue():
    ...
    r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/2/state", data="{\"bri\": 100}")
    r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/3/state", data="{\"bri\": 100}")
    r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/4/state", data="{\"bri\": 100}")
    r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/5/state", data="{\"bri\": 100}")
    ...
    r = requests.put(f"http://{hue_host}/api/2/lights/{str(hue_led)}/state", data="{\"on\": true}")
    r = requests.put(f"http://{hue_host}/api/3/lights/{str(hue_led)}/state", data="{\"on\": true}")
    r = requests.put(f"http://{hue_host}/api/4/lights/{str(hue_led)}/state", data="{\"on\": true}")
    r = requests.put(f"http://{hue_host}/api/5/lights/{str(hue_led)}/state", data="{\"on\": true}")

    while 1:
        ## Change colors
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/{str(hue_led)}/state", data="{\"xy\": " + str(colors["white"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/2/state", data="{\"xy\": " + str(colors["white"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/3/state", data="{\"xy\": " + str(colors["white"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/4/state", data="{\"xy\": " + str(colors["white"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/5/state", data="{\"xy\": " + str(colors["white"]) + "}")
        time.sleep(0.5)

        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/{str(hue_led)}/state", data="{\"xy\": " + str(colors["red"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/2/state", data="{\"xy\": " + str(colors["red"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/3/state", data="{\"xy\": " + str(colors["red"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/4/state", data="{\"xy\": " + str(colors["red"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/5/state", data="{\"xy\": " + str(colors["red"]) + "}")
        time.sleep(0.5)

        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/{str(hue_led)}/state", data="{\"xy\": " + str(colors["blue"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/2/state", data="{\"xy\": " + str(colors["blue"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/3/state", data="{\"xy\": " + str(colors["blue"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/4/state", data="{\"xy\": " + str(colors["blue"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/5/state", data="{\"xy\": " + str(colors["blue"]) + "}")
        time.sleep(0.5)

        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/{str(hue_led)}/state", data="{\"xy\": " + str(colors["green"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/2/state", data="{\"xy\": " + str(colors["green"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/3/state", data="{\"xy\": " + str(colors["green"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/4/state", data="{\"xy\": " + str(colors["green"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/5/state", data="{\"xy\": " + str(colors["green"]) + "}")
        time.sleep(0.5)

        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/{str(hue_led)}/state", data="{\"xy\": " + str(colors["yellow"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/2/state", data="{\"xy\": " + str(colors["yellow"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/3/state", data="{\"xy\": " + str(colors["yellow"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/4/state", data="{\"xy\": " + str(colors["yellow"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/5/state", data="{\"xy\": " + str(colors["yellow"]) + "}")
        time.sleep(0.5)


        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/{str(hue_led)}/state", data="{\"xy\": " + str(colors["orange"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/2/state", data="{\"xy\": " + str(colors["orange"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/3/state", data="{\"xy\": " + str(colors["orange"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/4/state", data="{\"xy\": " + str(colors["orange"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/5/state", data="{\"xy\": " + str(colors["orange"]) + "}")
        time.sleep(0.5)

        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/{str(hue_led)}/state", data="{\"xy\": " + str(colors["purple"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/2/state", data="{\"xy\": " + str(colors["purple"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/3/state", data="{\"xy\": " + str(colors["purple"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/4/state", data="{\"xy\": " + str(colors["purple"]) + "}")
        r = requests.put(f"http://{hue_host}/api/{hue_token}/lights/5/state", data="{\"xy\": " + str(colors["purple"]) + "}")
        time.sleep(0.5)
